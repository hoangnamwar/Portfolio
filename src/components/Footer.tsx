...
const Footer = () => {
    ...
    return (
        // <Box sx={{ bgcolor: ((theme.palette.mode === 'dark') ? `${theme.palette.secondary.dark}` : `${theme.palette.secondary.light}`), 
        //             marginTop: '100px' }}> 

        <Box sx={{ bgcolor: `${theme.palette.secondary.main}`, marginTop: '100px' }}>
