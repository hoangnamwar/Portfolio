...
const dataExperience = [
  ...
  {
    title: "ReactJs - Làm việc tại HBLab",
    time: "12/2021 - nay",
    des: "Tìm hiểu, xây dựng, thiết kế giao diện (wireframe) dựa theo spec của khách hàng. \n \
         -Tìm hiểu các công nghệ ứng sử dụng trong dự án. \n\
        -Xây dựng và config base project. \n\
        -Xây dựng và phát triển dự án. \n\
        -Kiểm thử dự án (test) và giải quyết các vấn đề phát sinh \n\
        -Bảo trì dự án (Maintenance).",
  },
];
const dataEducation = [
  {
      ...
      <Container maxWidth="lg">
        ...
        <Grid container spacing={12}>
          <Grid item lg={6} md={6} sm={6} xs={12}>
            <Typography variant="h5">Kinh Ngiệm</Typography>
            <TimelineResume data={[...dataExperience]} />
          </Grid>
          <Grid item lg={6} md={6} sm={6}>
            <Typography variant="h5">Học vấn</Typography>
            <TimelineResume data={[...dataEducation]} />
          </Grid>
        </Grid>
      </Container>
    </Box>
