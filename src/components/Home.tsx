        ...
        <Grid container spacing={6}>
          <Grid item lg={6} md={6} sm={12} xs={12}>
            ...
            <Typography variant="body1">
              ...
              cho lập trình front-end. Tôi mong muốn được đóng góp sức mình cho
              công ty.
            </Typography>
            <Box sx={{ padding: "30px 0 30px 0" }}>
              <Link
                href="https://www.facebook.com/hoangnam.war/"
                target="_blank"
              >
                <FacebookIcon color="primary" fontSize="large" />
              </Link>
              <Link
                href="https://www.linkedin.com/in/vu-nam-a9b743155/"
                target="_blank"
              >
              ...
              >
                <Typography
                  ...
                  sx={{
                    color: `${
                      theme.palette.mode === "dark" ? "#1976d2" : "#fff"
                    }`,
                    fontWeight: 600,
                  }}
                >
